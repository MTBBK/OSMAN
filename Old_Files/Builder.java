...
// String[][] fileContents = new String[fileNames.length][2]; // [i][0] -
// dosyanın adı, [i][1] - dosyanın içeriği
...
// StringBuilder setBaseStyle(String[][] templates, String style) throws
// IOException {
// int baseIndex = -1;
// for (int i = 0; i < templates.length; i++) {
...
// baseSB.replace(styleIndex, styleIndex + themeName.length(),
// themePath.toString());

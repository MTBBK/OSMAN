...
| ------- | -------------------------------------------- | -------- |
| 1 | Kullanıcı, sistemi hızla kurabilecek. | 34 |
...
| 9 | Sistemdeki hata ve sıkıntıların geri bildirimi kullanıcı açısından ulaşılabilir bir adresle sağlanacak. | 2 |
| 10 | Kullanıcı, sistemi gerektiğinde kolayca kaldırabilecek. | 1 |
| 11 | Kullanıcı, "osman.guru" internet sitemizdeki kullanıcı kılavuzu sayesinde pek çok soru ve sorununa cevap bulacak. | 1 |
| 12 | Kullanıcı isterse kendi ürettiği ve düzenlediği temaları "osman.guru" adresindeki bağlantılar sayesinde geliştiricilere öneri olarak sunabilecek.| 0 |
| 13 | Kullanıcı, bilgisi dahilindeyse sistemin dosyalarını dilediği gibi modifiye ederek açık kaynak proje kullanmanın faydasını görebilecek. | 6765 |
